...
const AP_Param::Info Copter::var_info[] = {
    ...
    // @User: Standard
    GSCALAR(failsafe_battery_enabled, "FS_BATT_ENABLE", FS_BATT_LAND),
    ...
    //{ AP_PARAM_GROUP, BATT, Parameters::k_param_battery, (const void *)&copter.battery, {group_info : AP_BattMonitor::var_info} }
