...
#define configUSE_PORT_OPTIMISED_TASK_SELECTION	0  /*开了这个选项最大优先级数只能设到32*/
...
#define configMAX_PRIORITIES					( 256 ) /*有效优先级号 0-configMAX_PRIORITIES-1*/
#define configMINIMAL_STACK_SIZE				( ( unsigned short ) 400 )
#define configTOTAL_HEAP_SIZE					( 800 * 1024)
