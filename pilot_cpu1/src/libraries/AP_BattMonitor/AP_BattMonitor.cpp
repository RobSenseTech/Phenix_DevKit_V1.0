...
const AP_Param::GroupInfo AP_BattMonitor::var_info[] = {
    ...
    // @User: Standard
    AP_GROUPINFO("_VOLT_PIN", 1, AP_BattMonitor, _volt_pin[0], AP_BATT_VOLT_PIN),//¶ÔÓ¦µ½pin_scaling
    ...
    // @Values: 0:Disabled,3:Analog Voltage Only,4:Analog Voltage and Current,5:SMBus,6:Bebop
    // @User: Standard
    AP_GROUPINFO("2_MONITOR", 11, AP_BattMonitor, _monitoring[1], BattMonitor_TYPE_ANALOG_VOLTAGE_AND_CURRENT),
