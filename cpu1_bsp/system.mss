...
BEGIN PROCESSOR
 ...
 PARAMETER extra_compiler_flags = -mcpu=cortex-a9 -mfpu=vfpv3 -mfloat-abi=hard -nostartfiles -DUSE_AMP=1 -mcpu=cortex-a9 -mfpu=vfpv3 -mfloat-abi=hard -nostartfiles
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = myip_pwm
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = myip_pwm_1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = myip_pwm
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = myip_pwm_2
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = myip_pwm
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = myip_pwm_3
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = myip_pwm
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = myip_pwm_4
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = myip_pwm
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = myip_pwm_5
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = myip_pwm
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = myip_pwm_6
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = myip_pwm
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = myip_pwm_7
END
